...
def new_user():
    if current_user.is_authenticated == True:
        ...
        if request.method == 'POST':
            ...
            password = generate_password_hash(request.form.get('password', type=str), method='sha256')
...
def new_room():
    if current_user.is_authenticated == False:
        ...
        if request.method == 'POST':
            ...
            roomPASS = generate_password_hash(request.form.get('roomPASS', type=str), method='sha256')
